...
public class RecordsActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        histoEntries.add(new IndividualRecord("100000000", "My Gospel","100000", "20"));
        histoEntries.add(new IndividualRecord("200000000", "Cheap Thrills","200000", "10"));
        histoEntries.add(new IndividualRecord("300000000", "Take Me to Church","60000", "0"));
